...
from management_projet_backend import settings as production_settings
from management_projet_backend.asgi import application
...
def test_channel_layer_socket_timeout_exceeds_blocking_pop_timeout():
    ...
    assert redis_host["socket_connect_timeout"] == 5
