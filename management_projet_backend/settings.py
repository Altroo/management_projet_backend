...
ROOT_URLCONF = "management_projet_backend.urls"
...
ASGI_APPLICATION = "management_projet_backend.asgi.application"
WSGI_APPLICATION = "management_projet_backend.wsgi.application"
...
REST_FRAMEWORK = dict(
    ...
    EXCEPTION_HANDLER="management_projet_backend.utils.api_exception_handler",
...
REST_AUTH = {
    ...
    "JWT_AUTH_COOKIE": "management_projet-jwt-access",
    "JWT_AUTH_REFRESH_COOKIE": "management_projet-jwt-refresh",
    "TOKEN_MODEL": None,
...
AI_TRANSLATION_SPECIALIST_ENABLED = config(
    "AI_TRANSLATION_SPECIALIST_ENABLED", default=True, cast=bool
)
AI_TRANSLATION_BASE_URL = config(
    "AI_TRANSLATION_BASE_URL", default="http://ai-translation:8080"
)
AI_TRANSLATION_MODEL_ID = config(
    "AI_TRANSLATION_MODEL_ID", default="opus-mt-fr-en+en-fr-cpu-bounded"
)
...
EBH_SSO_APP_SLUG = config("EBH_SSO_APP_SLUG", default="management_projet")
