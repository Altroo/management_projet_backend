...
from management_projet_backend.celery_conf import app
from management_projet_backend.settings import STATIC_PATH
from management_projet_backend.utils import ImageProcessor
